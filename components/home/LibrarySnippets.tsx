...
export const LibrarySnippets = () => {
  return (
    <Section className="py-20 space-y-4">
        <h2 className="text-4xl my-4 font-bold text-transparent bg-clip-text bg-gradient-to-r from-accent-pink via-purple-500 to-cyan-600">Library of Code Snippets</h2>
        <p className='text-muted-foreground text-lg'>List of code snippets that I store for easy access.</p>
